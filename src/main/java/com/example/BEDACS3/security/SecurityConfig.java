    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/auth/login", "/api/auth/register", "/api/admin/chat/**","/api/auth/refresh","/ws-chat/**","/upload/**").permitAll()
...
//"/api/home/**", "/api/products/**",,"/api/chat/**","/api/ai-chat/**","/api/admin/chat/**"